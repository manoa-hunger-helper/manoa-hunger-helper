...
class EditMyMenu extends React.Component {
  ...
  renderPage() {
    return (
      <Grid container centered>
        <Grid.Column>
          <Header as="h2" textAlign="center" color="orange" style={{ paddingTop: '30px', paddingBottom: '20px' }}>Edit My Menu</Header>
...
export default withTracker(({ match }) => {
  ...
  const subscription = Meteor.subscribe(FoodMenus.userPublicationName);
  // Determine if the subscription is ready
  const ready = subscription.ready();
  // Get the document
  const doc = FoodMenus.collection.findOne(documentId);
  return {
    doc,
    ready,
  };
